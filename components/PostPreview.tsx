...
export const PostPreview: React.FC<PostPreviewProps> = ({ pageId, content, imageUrl }) => {
  return (
    <div className="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-4 shadow-md">
      <div className="flex items-center mb-3">
        ...
        <div className="ml-3">
          <p className="font-bold text-sm text-gray-900 dark:text-gray-100">{`Page ID: ${pageId}`}</p>
